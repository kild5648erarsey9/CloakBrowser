...
> **Personal note:** Added `slow_mo=50` to my usual instantiation when debugging a scraper — makes it much easier to visually follow what the browser is doing without it flying through steps too fast to catch.
