...
> **Personal note:** Added `slow_mo=50` to my usual invocations when debugging — makes it much easier to visually follow what the browser is doing without it being too sluggish.
